...
//屏蔽了TIM_GenerateEvent()函数
//这是方波控制类型，暂时没有移植，不可用的状态
//#define HW_GET_INJ_CURR1() 0
//#define	HW_GET_INJ_CURR2() 0
//#define	HW_GET_INJ_CURR1_S2() 0
//#define	HW_GET_INJ_CURR3() 0
...
void mcpwm_adc_int_handler(void *p, uint32_t flags) {
	...
	if (encoder_is_configured()) {
		...
		run_pid_control_pos(1.0f / switching_frequency_now, pos);
		pll_run(-DEG2RAD_f(pos), 1.0f / switching_frequency_now, &m_pll_phase, &m_pll_speed);
	}
